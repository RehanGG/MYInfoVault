...
export default forwardRef(function ImageInput ({label, id, disabled = false, validations = []}, ref) {
    ...
    return (
        <>
            ...
            <div style={{ height: "120px", width: "120px" }} className="rounded-full overflow-hidden">
                <img style={{ width: "100%", height: "100%", objectFit: "cover" }} src={generateImgUrl()} alt="" />
            </div>
                {!value && <span className="text-gray-800 text-sm">{label}</span>}
